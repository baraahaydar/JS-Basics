...
img1.addEventListener("mouseout", () => { RchangeImg("img1") });
img2.addEventListener("mouseout", () => { RchangeImg("img2") });
img3.addEventListener("mouseout", () => { RchangeImg("img3") });
img4.addEventListener("mouseout", () => { RchangeImg("img4") });
img5.addEventListener("mouseout", () => { RchangeImg("img5") });